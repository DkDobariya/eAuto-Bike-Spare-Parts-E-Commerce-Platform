...
<div class="container py-5">
  <h2 class="text-center mb-5" data-aos="fade-down">Honda</h2>

  <?php
  $query = "SELECT * FROM products WHERE main_brand = 'Honda'";
  ...
  <?php endforeach; else: ?>
    <div class="alert alert-warning text-center">No Hero products found.</div>
  <?php endif; ?>
</div>
